...
import type { HeaderMenusData } from "@/lib/headerMenus";
...
export function HeaderClient({
  ...
  const activePropertyCategory = useMemo(
    ...
    [propertyActiveId, propertyServicesMenu],
  );
                    ...
                    return (
                      <div key={sec.id} className="flex flex-col gap-1">
                        <button
                          ...
                          onClick={() => {
                            setMobileBusinessSectionId((id) =>
                              id === sec.id ? null : sec.id,
                            );
                            setMobileBusinessCategoryId(null);
                          }}
                        >
                    ...
                    return (
                      <div key={cat.id} className="flex flex-col gap-1">
                        <button
                          ...
                          aria-expanded={expanded}
                          onClick={() =>
                            setMobilePropertyCategoryId((id) =>
                              id === cat.id ? null : cat.id,
                            )
                          }
                        >
